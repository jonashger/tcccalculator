...
public class CadastroTCC1 extends JInternalFrame {
	...
	public void gerarMedias() {
		...
		if (avaliador1.getText().equals("") || avaliador2.getText().equals("") || avaliador3.getText().equals("")) {
			pass = false;
		}
		if (pass) {
